...
opts.Add(EnumVariable('plugin', 'Plugin to build', '', ['', 'apn', 'arkit', 'camera', 'icloud', 'gamecenter', 'inappstore', 'photo_picker', 'godot3_taptap', 'godot3_cloudsave']))
...
if env['plugin'] == 'godot3_taptap':
    sdk_frameworks = [
        ...
        'plugins/godot3_taptap/sdk/TapTapAchievementSDK.xcframework/' + ('ios-arm64' if not env['simulator'] else 'ios-arm64_x86_64-simulator'),
    ]
